...
describe("#countLetters", () => {
  ...
  it("returns 2 for 'i' in result1", () => {
      assert.strictEqual(countLetters(result1).i, 2);
  });
  it("returns undefined for 'k' in result1", () => {
    assert.deepEqual(countLetters(result1).k, undefined);
  });
